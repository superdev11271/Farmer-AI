...
import { Trash2, Plus, Save, X, DollarSign, TrendingUp, Building2, Eye } from "lucide-react";
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {draftInvoices.map(invoice => (
                <tr key={invoice.id} className="hover:bg-gray-50 transition-colors duration-150">
                  {["category_identifier", "Datum", "LitersTotaal", "LitersPrivé", "Litersbedrijf", "Bedrag", "BTW"].map(field => (
                    <td
                      key={field}
